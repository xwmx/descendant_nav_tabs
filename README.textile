...
To use, define an array of hashed tab definitions in ApplicationController with active_nav_tabs using the :tabs option. The order the tabs are defined in the array defines the order they will be displayed. Each tab can be defined using three options:
